...
export class CreateMetattachPage extends BasePage {
	...
	constructor(public navCtrl: NavController,
		private metattachService: MetattachService, public router: Router,
		public uxNotifierService: UxNotifierService, private loadingCtrl: LoadingController, public platform: Platform,
	...
	public setImage() {
		if (this.IsMetattachment) {
			...
			if (this.LastSavedItem.GoogleTextDetails != undefined) {
				this.image = 'https://firebasestorage.googleapis.com/v0/b/itt-content.appspot.com/o/Common%2Fassets%2Fsvgs%2Fregular%2Fglobe.svg?alt=media&token=aac6d1a7-8dd1-4b35-bac1-b0961b6e50fc';
			}

			// Qr Code
			if (this.LastSavedItem.Type == 'Qr Code') {
				this.image = 'https://firebasestorage.googleapis.com/v0/b/itt-content.appspot.com/o/Common%2Fassets%2Fsvgs%2Fregular%2Fqrcode.svg?alt=media&token=80c296d2-280c-4c42-aa19-50b0027fe89a';
			}
			...
			if (this.LastSavedItem.Type == 'DigiDoc') {
				...
				if (this.LastSavedItem.ContentType.indexOf('png') != -1) {
					...
					this.image = 'https://firebasestorage.googleapis.com/v0/b/itt-content.appspot.com/o/Common%2Fassets%2Fsvgs%2Fregular%2Ffile-alt.svg?alt=media&token=5fc4313c-3c89-45e0-b447-f9fd9500afa6';
				}
			}
	...
	public async start() {
		...
		await this.metattachService.getMetattachTypeByLineItemId(this.LineItem.Id)
			.then(
	...
	public async save() {
		...
		this.metattachService.saveMetattach(metattachData)
			.then(
				async (x) => {
