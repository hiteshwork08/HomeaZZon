...
export class AccountService extends baseService {
	...
	authenticate(loginDto) {
		...
		return this.http.post(`${environment.httpBase}/token`, formData, {
			headers: {
	...
	sendVerificationEmail(email, subject, message) {
		return this.get("http://emailservice.cognitivegenerationenterprises.com/home/sendemail?toEmail=" + email + "&subject=" + subject + "&message=" + message).toPromise();
	}
